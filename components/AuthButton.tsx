...
export default function AuthButton({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 z-[900] mt-2 max-h-[min(72svh,34rem)] w-[min(18rem,calc(100vw-2rem))] overflow-y-auto rounded-2xl border border-violet-300/20 bg-zinc-950/95 text-sm text-white shadow-2xl shadow-black/40 backdrop-blur-md">
          {isConnected ? (
            <>
